...
#SBATCH --output=/u/erdos/cnslab/xcui32/EfficientVideoRec/results/adaperturbed_vit_369_0.7_nofreeze/output.out
...
RUN_NAME="evit_deit_small_369_0.7_nofreeze"
...
python3 /u/erdos/cnslab/xcui32/EfficientVideoRec/main.py \
 ...
 --train True \
 --mode reducer-img --model deit_small_patch16_224_shrink_base \
 --keep_ratio 0.7 \
