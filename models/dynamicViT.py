...
copied from https://github.com/raoyongming/DynamicViT/blob/48ac52643a637ed5a4cf7c7d429dcf17243794cd/models/dyvit.py#L287 for reproduction
"""
import math
import logging
...
if __name__ == '__main__':
    model = VisionTransformerDiffPruning(pruning_loc=[3,6,9], token_ratio=[.7,.7,.7])
    model.eval()
